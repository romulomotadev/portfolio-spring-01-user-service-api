...
public class UserFactory {
    ...
    public static User createUserEmailDuplicate() {
        ...
        Address address1 = new Address(4L, "Rua dos Bobos", "01", "Bairro", "Trabalho", "Cidade-MG", "00000-000");
        Address address2 = new Address(5L, "Rua A", "2A", "Bairro", "Casa", "Cidade-SP", "00000-000");
    ...
    public static User createUserDocumentDuplicate() {
        Person person = new Person(
                3L,
                "10.246.571/0001-16",
                NATURAL_PERSON);
        ...
        Address address1 = new Address(6L, "Rua dos Bobos", "01", "Bairro", "Trabalho", "Cidade-MG", "00000-000");
        Address address2 = new Address(7L, "Rua A", "2A", "Bairro", "Casa", "Cidade-SP", "00000-000");
